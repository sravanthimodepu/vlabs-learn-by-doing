...
$THEME->sheets = array('core','base','course','slider','default','frontpage','skeleton','login','owlcarousel','owltheme');
...
$sidebar['general'] = get_config('theme_saga', 'generalsidebar');
...
$THEME->csspostprocess = 'saga_process_css';
...
$THEME->javascripts = array('jquery-1.10.2.min','modernizr.custom');
...
$THEME->javascripts_footer = array('jquery.ba-cond.min','jquery.slitslider','classie','owl.carousel.min','frontpage.custom');
