...
################# mediawiki database ##################
mysql -u root -p'VLead@123' -e "create database wiki; GRANT ALL PRIVILEGES ON wiki.* TO root@localhost IDENTIFIED BY 'VLead@123'; FLUSH PRIVILEGES"
...
############## moodle database ###############################
mysql -u root -p'VLead@123' -e "create database moodle; GRANT ALL PRIVILEGES ON moodle.* TO root@localhost IDENTIFIED BY 'VLead@123'; FLUSH PRIVILEGES"
